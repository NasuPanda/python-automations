...
class ExcelAccessor:
    ...
    def add_image(self, attached_img: types.AttachedImage) -> None:
        """Paste image into active sheet.
    ...
    def add_scatter_chart(self, graph_src: types.Graph):
        """Add scatter chart into active sheet.
        ...
        """
        # FIXME 散布図のみかつ特定フォーマットしか対応していない
        ...
        for i, primary_data in enumerate(graph_src.primary_data_collection):
            primary_y_value = Reference(
                self._active_worksheet, **primary_data.members_as_dict
            )
        ...
        secondary_y_value = Reference(
            self._active_worksheet, **graph_src.secondary_data.members_as_dict
        )
        ...
        secondary_chart.y_axis.scaling.min = graph_src.secondary_y_axis_min_vale
        secondary_chart.y_axis.scaling.min = graph_src.secondary_y_axis_max_vale
        secondary_chart.y_axis.majorUnit = graph_src.secondary_y_axis_interval
